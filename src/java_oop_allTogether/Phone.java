...
public interface Phone extends Pager, Wakitaki {
	...
	public static void main(String[] args) {
		System.out.println(
				"What is interface?: Interface is the \"BluePrint\" of class. Method can only be declared here. Interface can not be instantiated. It contains default and Static methods which are non abstract method. Interface contains only abstract method.\nConstractor can not be created inside it. We can not write variables inside it.");
